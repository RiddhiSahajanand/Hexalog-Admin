...
const AddCategories = ({ show, handleClose, handleSubmit, fetchData }) => {
    ...
    return (
        <Modal show={show} onHide={handleClose} centered >
            <div className='categories-modal-header' >
                <Modal.Title className="fw-bold categories-contact-title">Add New Document Category</Modal.Title>
            </div>
